...
Config.Stores = {
    [1] = {shopType = 'clothing', coords = vector3(1693.30, 4828.02, 42.06), width = 2, length = 2},
    [2] = {shopType = 'clothing', coords = vector3(-710.71, -155.24, 37.42), width = 2, length = 2},
    [3] = {shopType = 'clothing', coords = vector3(-1189.01, -769.41, 17.33), width = 2, length = 2},
    [4] = {shopType = 'clothing', coords = vector3(426.49, -801.14, 29.49), width = 2, length = 2},
    [5] = {shopType = 'clothing', coords = vector3(-160.94, -302.65, 39.73), width = 2, length = 2},
    [6] = {shopType = 'clothing', coords = vector3(74.76, -1397.52, 29.37), width = 2, length = 2},
    [7] = {shopType = 'clothing', coords = vector3(-826.69, -1075.23, 11.33), width = 2, length = 2},
    [8] = {shopType = 'clothing', coords = vector3(-1452.58, -236.59, 49.81), width = 2, length = 2},
    [9] = {shopType = 'clothing', coords = vector3(8.82, 6514.87, 31.88), width = 2, length = 2},
    [10] = {shopType = 'clothing', coords = vector3(617.48, 2765.59, 42.09), width = 2, length = 2},
    [11] = {shopType = 'clothing', coords = vector3(1191.79, 2711.06, 38.22), width = 2, length = 2},
    [12] = {shopType = 'clothing', coords = vector3(-3175.18, 1041.99, 20.86), width = 2, length = 2},
    [13] = {shopType = 'clothing', coords = vector3(-1105.67, 2708.02, 19.11), width = 2, length = 2},
    [14] = {shopType = 'clothing', coords = vector3(121.10, -225.52, 54.56), width = 2, length = 2},


    [15] = {shopType = 'barber', coords = vector3(-278.1, 6228.5, 30.7), width = 2, length = 2},
...
Config.OutfitChangers = {
    [1] = {shopType = 'outfit', coords = vector3(1698.59, 4819.80, 42.06), width = 2, length = 2},
    [2] = {shopType = 'outfit', coords = vector3(-704.66, -151.47, 37.42), width = 2, length = 2},
    [3] = {shopType = 'outfit', coords = vector3(-1182.57, -765.10, 17.33), width = 2, length = 2},
    [4] = {shopType = 'outfit', coords = vector3(429.52, -809.31, 29.50), width = 2, length = 2},
    [5] = {shopType = 'outfit', coords = vector3(-167.87, -299.97, 39.73), width = 2, length = 2},
    [6] = {shopType = 'outfit', coords = vector3(71.27, -1389.84, 29.38), width = 2, length = 2},
    [7] = {shopType = 'outfit', coords = vector3(-822.32, -1068.63, 11.33), width = 2, length = 2},
    [8] = {shopType = 'outfit', coords = vector3(-1447.55, -242.12, 49.82), width = 2, length = 2},
    [9] = {shopType = 'outfit', coords = vector3(5.94, 6507.62, 31.88), width = 2, length = 2},
    [10] = {shopType = 'outfit', coords = vector3(617.48, 2773.35, 42.09), width = 2, length = 2},
    [11] = {shopType = 'outfit', coords = vector3(1199.84, 2713.95, 38.23), width = 2, length = 2},
    [12] = {shopType = 'outfit', coords = vector3(-3178.49, 1035.63, 20.86), width = 2, length = 2},
    [13] = {shopType = 'outfit', coords = vector3(-1101.88, 2715.60, 19.11), width = 2, length = 2},
    [14] = {shopType = 'outfit', coords = vector3(118.51, -232.09, 54.56), width = 2, length = 2},
}
